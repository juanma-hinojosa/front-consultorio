    ...
    <div className="crear-paciente">
      ...
      <section className='ui-form-container'>
        <form className="ui-form poppins-light" onSubmit={handleSubmit}>
          ...
          <input className="ui-input" name="dni" type='number' value={form.dni} onChange={handleChange} placeholder="DNI" required />
          ...
          <textarea rows={25} className="ui-textarea" name="alergias" value={form.alergias} onChange={handleChange} placeholder="Alergias (si hay)" />
